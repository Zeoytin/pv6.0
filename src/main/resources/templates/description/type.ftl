                    ...
                    <form class="form-horizontal" role="form">
                        <div class="form-group">
                            <label for="name" class="col-sm-3 control-label"><span
                                        style="color: red;">*</span>类型名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="typeName" value="" id="typeName"
                                       placeholder="请输入类型名称">
                            </div>
                        </div>
                    </form>
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label for="name1" class="col-sm-3 control-label"><span
                                        style="color: red;">*</span>类型名称</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="typeName" value="" id="typeName1"
                                       placeholder="请输入类型名称">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function initTable() {
        $('#mytable').bootstrapTable({
            ...
            url: '../description/findType',//请求路径
            toolbar: '#toolbar',//工具按钮用哪个容器
            height: 500, //自定义表格的高度,
            responseHandler: function (res) {
                console.log("返回数据=", res)
                return res.data.typeList;
            },
            columns: [{
                checkbox: true
            }, {
