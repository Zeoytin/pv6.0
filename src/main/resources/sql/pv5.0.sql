...
Source Database       : pv4.0

Target Server Type    : MYSQL
Target Server Version : 50722
File Encoding         : 65001

Date: 2019-04-07 16:01:41
*/
...
INSERT INTO `permission` VALUES ('2', 'insert', '添加');
...
INSERT INTO `role` VALUES ('2', '录入用户');
...
CREATE TABLE `role_permission` (
  ...
  PRIMARY KEY (`rid`,`pid`),
  KEY `pid` (`pid`),
  CONSTRAINT `pid` FOREIGN KEY (`pid`) REFERENCES `permission` (`id`),
...
INSERT INTO `user` VALUES ('2', 'zyt', '123456', '1');
INSERT INTO `user` VALUES ('3', 'user', '123456', '1');
INSERT INTO `user` VALUES ('4', '测试', '123', '1');
